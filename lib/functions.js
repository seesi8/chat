...
export async function inviteFriend(friendId, user, data, threadId, members) {
  // let messagesName;
  ...
  const messageHandler = await GroupMessageHandler.create(user, data, threadId)
  messageHandler.addUser(friendId)
}

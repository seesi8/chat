...
import { getSupplimentalPrivateKeyPairs } from "./functions";
    ...
    useEffect(() => {
        ...
        if (user) {
            ...
            unsubscribe = onSnapshot(ref, async (doc) => {
                ...
                const supplimentalKeyPairs = await getSupplimentalPrivateKeyPairs()
                setData({...doc.data(), privateKey: private_key, ...supplimentalKeyPairs});
            });
        } else {
            setData(null);
        }
